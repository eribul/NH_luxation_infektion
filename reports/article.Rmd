...
author: Erik Bulow,^1,2^ Alma Besic Pedersen,^3^ Ina Trolle Andersen,^4^ Ola Rolfson,^1,2^  Nils P. Hailer^5^
date: '`r Sys.Date()`'
bibliography: 
#  H:/zotero_lib.bib
...
**Correspondance:** [erik.bulow\@vgregion.se](mailto:erik.bulow@vgregion.se){.email}; +46 70 08 234 28; Svenska Hoftprotesregistret, Registercentrum Vastra Gotaland, SE-413 45, Sweden
...
We built an online web calculator available at **XXX** to be used in clinical practice. `r R.version.string` (R Foundation for Statistical Computing, Vienna, Austria) with significant packages tidyverse, tidymodels, furrr, pROC, decoder, coder and shiny were used.
