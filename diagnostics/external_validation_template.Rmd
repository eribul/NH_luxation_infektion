...
Load the exported models to validate (the R object previously sent, probably with another path). This is a nested data frame with one row for each prediction period (90 days and 2 years). Column `fit` contains `glm` object stripped from any personal patient data.
